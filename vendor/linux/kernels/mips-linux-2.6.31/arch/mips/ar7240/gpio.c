...
int __init ar7240_simple_config_init(void)
{
  ...
  //  ret = misc_register(&ar7240fr_miscdev);
...
#endif
	//ar7240_gpio_config_input(CONFIG_JUMPSTART_GPIO);
	/* configure Jumpstart GPIO as level triggered interrupt */
    //if (is_ar933x_11()) {
   //     ar7240_gpio_config_int (CONFIG_JUMPSTART_GPIO, INT_TYPE_LEVEL, INT_POL_ACTIVE_HIGH);
   // } else {
     //   ar7240_gpio_config_int (CONFIG_JUMPSTART_GPIO, INT_TYPE_LEVEL, INT_POL_ACTIVE_LOW);
    //}
	...
	ar7240_reg_rmw_set(AR7240_GPIO_FUNCTIONS, (1 << 0));
	//ar7240_reg_rmw_clear(AR7240_GPIO_FUNCTIONS, (1 << 20));
#endif
#endif


   // req = request_irq (AR7240_GPIO_IRQn(CONFIG_JUMPSTART_GPIO), jumpstart_irq, 0,
   ...
   //     ar7240_gpio_intr_shutdown(AR7240_GPIO_IRQn(CONFIG_JUMPSTART_GPIO));
   //     return -1;
    //}
/*
#ifdef AP_USB_LED_GPIO
