...
#ifdef HS100 
	ar7240_reg_wr (AR7240_GPIO_OE, (ar7240_reg_rd(AR7240_GPIO_OE) | (0x1<<14)));
	ar7240_reg_wr (AR7240_GPIO_OE, (ar7240_reg_rd(AR7240_GPIO_OE) | (0x1<<15)));
	ar7240_reg_wr (AR7240_GPIO_OE, (ar7240_reg_rd(AR7240_GPIO_OE) | (0x1<<16)));
	/* turn off all leds */
	ar7240_reg_wr (AR7240_GPIO_OUT, (ar7240_reg_rd(AR7240_GPIO_OUT) & ~(0x1<<14)));
	ar7240_reg_wr (AR7240_GPIO_OUT, (ar7240_reg_rd(AR7240_GPIO_OUT) & ~(0x1<<15)));
	ar7240_reg_wr (AR7240_GPIO_OUT, (ar7240_reg_rd(AR7240_GPIO_OUT) & ~(0x1<<16)));
	// red and green on to make orange
	ar7240_reg_wr (AR7240_GPIO_OUT, (ar7240_reg_rd(AR7240_GPIO_OUT) | (0x1<<15)));
	ar7240_reg_wr (AR7240_GPIO_OUT, (ar7240_reg_rd(AR7240_GPIO_OUT) | (0x1<<16)));
#endif	
#ifdef HS110 
...
#endif	
#ifdef HS200 
	ar7240_reg_wr (AR7240_GPIO_OE, (ar7240_reg_rd(AR7240_GPIO_OE) | (0x1<<13)));
	ar7240_reg_wr (AR7240_GPIO_OE, (ar7240_reg_rd(AR7240_GPIO_OE) | (0x1<<26)));
	ar7240_reg_wr (AR7240_GPIO_OE, (ar7240_reg_rd(AR7240_GPIO_OE) | (0x1<<27)));
	/* turn off all leds */
	ar7240_reg_wr (AR7240_GPIO_OUT, (ar7240_reg_rd(AR7240_GPIO_OUT) & ~(0x1<<13)));
	ar7240_reg_wr (AR7240_GPIO_OUT, (ar7240_reg_rd(AR7240_GPIO_OUT) & ~(0x1<<26)));
	ar7240_reg_wr (AR7240_GPIO_OUT, (ar7240_reg_rd(AR7240_GPIO_OUT) & ~(0x1<<27)));
	// red and green on to make orange
	ar7240_reg_wr (AR7240_GPIO_OUT, (ar7240_reg_rd(AR7240_GPIO_OUT) | (0x1<<27)));
	ar7240_reg_wr (AR7240_GPIO_OUT, (ar7240_reg_rd(AR7240_GPIO_OUT) | (0x1<<26)));
#endif		
