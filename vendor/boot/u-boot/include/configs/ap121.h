...
#if (FLASH_SIZE == 4)
#define	CONFIG_BOOTARGS     "console=ttyS0,115200 root=31:02 rootfstype=squashfs init=/sbin/init mtdparts=ar7240-nor0:64k(u-boot),1024k(uImage),2752k(rootfs),64k(TPHead),64k(config),64k(log),64k(ART),3904k@0x0(firmware)"
#define MTDPARTS_DEFAULT    "mtdparts=ar7240-nor0:64k(u-boot),1024k(uImage),2752k(rootfs),64k(TPHead),64k(config),64k(log),64k(ART),3904k@0x0(firmware)"
#elif (FLASH_SIZE == 8)
#define	CONFIG_BOOTARGS     "console=ttyS0,115200 root=31:02 rootfstype=squashfs init=/sbin/init mtdparts=ar7240-nor0:128k(u-boot),1024k(uImage),6912k(rootfs),64k(NVRAM),64k(ART),7936k@0x20000(firmware)"
#define MTDPARTS_DEFAULT    "mtdparts=ar7240-nor0:128k(u-boot),1024k(uImage),6912k(rootfs),64k(NVRAM),64k(ART),7936k@0x10000(firmware)"
#else
#define	CONFIG_BOOTARGS     "console=ttyS0,115200 root=31:02 rootfstype=squashfs init=/sbin/init mtdparts=ar7240-nor0:64k(u-boot),768(uImage),1088k(uImage),64k(NVRAM),64k(ART)"
#define MTDPARTS_DEFAULT    "mtdparts=ar7240-nor0:64k(u-boot),768(uImage),1088k(uImage),64k(NVRAM),64k(ART)"
#endif
